...
function CurrentFlowAspect(props) {
	const { aspectFlow, setAspectFlow, setLifeUnits, setAspectId } = props;
...
export default function LifeFlow({ setAspectId, completedTodos }) {
	...
	return (
		<div className="life-flow">
			...
			>
				<FlowSettings getAspectName={getAspectName} />
			</OffscreenContainer>
		</div>
	);
}
